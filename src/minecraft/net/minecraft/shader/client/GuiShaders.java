...
public class GuiShaders extends GuiScreen
{
    ...
    public static float[] QUALITY_MULTIPLIERS = new float[] {0.5F, 0.70710677F, 1.0F, 1.4142135F, 2.0F};
    public static String[] QUALITY_MULTIPLIER_NAMES = new String[] {"0.5x", "0.7x", "1x", "1.5x", "2x"};
    ...
    public void actionPerformed(GuiButton button)
    {
        if (button.enabled)
        {
            if (button instanceof GuiButtonEnumShaderOption)
            {
                ...
                switch (GuiShaders.NamelessClass1268935892.$SwitchMap$shadersmod$client$EnumShaderOption[var11.getEnumShaderOption().ordinal()])
                {
                    case 1:
    ...
    public static class NamelessClass1268935892
    {
