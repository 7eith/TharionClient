...
public class GuiButtonEnumShaderOption extends GuiButton
{
    ...
    public static String getButtonText(EnumShaderOption eso)
    {
        String nameText = I18n.format(eso.getResourceKey(), new Object[0]) + ": ";

        switch (GuiButtonEnumShaderOption.NamelessClass414344236.$SwitchMap$shadersmod$client$EnumShaderOption[eso.ordinal()])
        {
            case 1:
    ...
    public static class NamelessClass414344236
    {
