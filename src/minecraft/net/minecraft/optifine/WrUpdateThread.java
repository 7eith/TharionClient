...
public class WrUpdateThread extends Thread
{
    ...
    public void run()
    {
        ...
        WrUpdateThread.ThreadUpdateListener updateListener = new WrUpdateThread.ThreadUpdateListener((WrUpdateThread.NamelessClass316585626)null);
    ...
    public static class NamelessClass316585626
    {
    }
    ...
    public class ThreadUpdateControl implements IWrUpdateControl
    {
        ...
        public ThreadUpdateControl(WrUpdateThread.NamelessClass316585626 x1)
        {
            this();
        }
    }
    ...
    {
        public WrUpdateThread.ThreadUpdateControl tuc;

        public ThreadUpdateListener()
        {
            this.tuc = WrUpdateThread.this.new ThreadUpdateControl((WrUpdateThread.NamelessClass316585626)null);
        }
        ...
        public ThreadUpdateListener(WrUpdateThread.NamelessClass316585626 x1)
        {
            this();
        }
    }
