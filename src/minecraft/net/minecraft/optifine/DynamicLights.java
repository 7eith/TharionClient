...
{
    public static Map<Integer, DynamicLight> mapDynamicLights = new HashMap();
    ...
    public static ReflectorField ItemBlock_block = Reflector.getReflectorField(ItemBlock.class, Block.class);
