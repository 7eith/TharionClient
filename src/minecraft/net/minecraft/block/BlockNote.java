...
public class BlockNote extends BlockContainer
{
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        if (var7 != null && var7.previousRedstoneState != var6)
        {
            if (var6)
            {
                var7.triggerNote(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_);
            }
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        else
        {
            ...
            {
                var10.changePitch();
                var10.triggerNote(p_149727_1_, p_149727_2_, p_149727_3_, p_149727_4_);
            }
    ...
    public void onBlockClicked(World p_149699_1_, int p_149699_2_, int p_149699_3_, int p_149699_4_, EntityPlayer p_149699_5_)
    {
        if (!p_149699_1_.isRemote)
        {
            ...
            if (var6 != null)
            {
                var6.triggerNote(p_149699_1_, p_149699_2_, p_149699_3_, p_149699_4_);
            }
        }
    }
