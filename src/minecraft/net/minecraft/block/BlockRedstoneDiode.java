...
public abstract class BlockRedstoneDiode extends BlockDirectional
{
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        ...
        {
            boolean var7 = this.isGettingInput(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_, var6);
            ...
            else if (!this.isRepeaterPowered)
            {
                ...
                if (!var7)
                {
                    p_149674_1_.scheduleBlockUpdateWithPriority(p_149674_2_, p_149674_3_, p_149674_4_, this.getBlockPowered(), this.func_149899_k(var6), -1);
                }
            }
        }
    }
