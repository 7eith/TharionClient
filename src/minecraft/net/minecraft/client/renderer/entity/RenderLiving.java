...
public abstract class RenderLiving extends RendererLivingEntity
{
    ...
    public boolean func_110813_b(EntityLiving par1EntityLivingBase)
    {
    ...
    public double func_110828_a(double par1, double par3, double par5)
    {
    ...
    public boolean func_110813_b(EntityLivingBase par1EntityLivingBase)
    {
