...
{
    public static final ResourceLocation enderDragonExplodingTextures = new ResourceLocation("textures/entity/enderdragon/dragon_exploding.png");
    ...
    public static final ResourceLocation enderDragonEyesTextures = new ResourceLocation("textures/entity/enderdragon/dragon_eyes.png");
    public static final ResourceLocation enderDragonTextures = new ResourceLocation("textures/entity/enderdragon/dragon.png");

    /** An instance of the dragon model in RenderDragon */
    public ModelDragon modelDragon;
    ...
    public void rotateCorpse(EntityDragon par1EntityLivingBase, float par2, float par3, float par4)
    {
     ...
     */
    public void renderModel(EntityDragon par1EntityLivingBase, float par2, float par3, float par4, float par5, float par6, float par7)
    {
     ...
     */
    public ResourceLocation getEntityTexture(EntityDragon par1Entity)
    {
        return enderDragonTextures;
    }

    public void renderEquippedItems(EntityDragon par1EntityLivingBase, float par2)
    {
     ...
     */
    public int shouldRenderPass(EntityDragon par1EntityLivingBase, int par2, float par3)
    {
        if (par2 == 1)
        {
            GL11.glDepthFunc(GL11.GL_LEQUAL);
    ...
    public void renderEquippedItems(EntityLivingBase par1EntityLivingBase, float par2)
    {
        this.renderEquippedItems((EntityDragon)par1EntityLivingBase, par2);
    }

    public void rotateCorpse(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4)
    {
