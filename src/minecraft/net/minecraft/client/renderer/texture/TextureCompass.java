...
public class TextureCompass extends TextureAtlasSprite
{
    ...
    public void updateCompass(World par1World, double par2, double par4, double par6, boolean par8, boolean par9)
    {
        if (!this.framesTextureData.isEmpty())
        {
            ...
            for (var181 = (int)((this.currentAngle / (Math.PI * 2D) + 1.0D) * (double)this.framesTextureData.size()) % this.framesTextureData.size(); var181 < 0; var181 = (var181 + this.framesTextureData.size()) % this.framesTextureData.size())
            {
                ;
            }
