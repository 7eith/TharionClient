    ...
    public void orientCamera(float par1)
    {
        ...
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            else
            {
                ...
                double var14 = (double)(-MathHelper.sin(var28 / 180.0F * (float)Math.PI) * MathHelper.cos(var29 / 180.0F * (float)Math.PI)) * var27;
                double var16 = (double)(MathHelper.cos(var28 / 180.0F * (float)Math.PI) * MathHelper.cos(var29 / 180.0F * (float)Math.PI)) * var27;
                double var18 = (double)(-MathHelper.sin(var29 / 180.0F * (float)Math.PI)) * var27;
        ...
        for (int var13 = 0; var13 < 2; ++var13)
        {
            ...
            if (this.debugViewDirection == 0)
            {
                ...
                if (this.mc.objectMouseOver != null && var4.isInsideOfMaterial(Material.water) && var4 instanceof EntityPlayer && !this.mc.gameSettings.hideGUI)
                {
                    ...
                    if ((!hasForge || !Reflector.callBoolean(Reflector.ForgeHooksClient_onDrawBlockHighlight, new Object[] {var5, var17, this.mc.objectMouseOver, Integer.valueOf(0), var17.inventory.getCurrentItem(), Float.valueOf(par1)})) && !this.mc.gameSettings.hideGUI)
                    {
