    ...
    public void onPlayerDamageBlock(int p_78759_1_, int p_78759_2_, int p_78759_3_, int p_78759_4_)
    {
        ...
        else
        {
            if (this.sameToolAndBlock(p_78759_1_, p_78759_2_, p_78759_3_))
            {
                ...
                {
                    this.mc.getSoundHandler().playSound(new PositionedSoundRecord(new ResourceLocation(var5.stepSound.getStepResourcePath()), (var5.stepSound.getVolume() + 1.0F) / 8.0F, var5.stepSound.getPitch() * 0.5F, (float)p_78759_1_ + 0.5F, (float)p_78759_2_ + 0.5F, (float)p_78759_3_ + 0.5F));
                }
