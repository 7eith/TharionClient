...
public class DynamicLight
{
    ...
    {
        switch (DynamicLight.NamelessClass1935446462.$SwitchMap$net$minecraft$util$EnumFacing[facing.ordinal()])
        {
            case 1:
    ...
    public void updateChunkLight(RenderGlobal renderGlobal, BlockPos pos, Set<BlockPos> setPrevPos, Set<BlockPos> setNewPos)
    {
        if (pos != null)
        {
    ...
    public static class NamelessClass1935446462
    {
