...
public class HttpPipelineConnection
{
    ...
    public int port;
    public Proxy proxy;
    public List<HttpPipelineRequest> listRequests;
    ...
    public HttpPipelineRequest getNextRequest(List<HttpPipelineRequest> list, boolean remove) throws InterruptedException
    {
        while (list.size() <= 0)
        {
            this.checkTimeout();
