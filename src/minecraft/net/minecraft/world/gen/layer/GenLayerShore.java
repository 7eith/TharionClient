        ...
        for (int var7 = 0; var7 < p_75904_4_; ++var7)
        {
            for (int var8 = 0; var8 < p_75904_3_; ++var8)
            {
                ...
                else if (var9 != BiomeGenBase.extremeHills.biomeID && var9 != BiomeGenBase.extremeHillsPlus.biomeID && var9 != BiomeGenBase.extremeHillsEdge.biomeID)
                {
                    ...
                    {
                        this.func_151632_a(var5, var6, var8, var7, p_75904_3_, var9, BiomeGenBase.coldBeach.biomeID);
                    }
                ...
                {
                    this.func_151632_a(var5, var6, var8, var7, p_75904_3_, var9, BiomeGenBase.stoneBeach.biomeID);
                }
            }
        }
