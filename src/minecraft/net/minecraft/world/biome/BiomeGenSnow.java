...
public class BiomeGenSnow extends BiomeGenBase
{
    ...
    {
        BiomeGenBase var1 = (new BiomeGenSnow(this.biomeID + 128, true)).func_150557_a(13828095, true).setBiomeName(this.biomeName + " Spikes").setEnableSnow().setTemperatureRainfall(0.0F, 0.5F).setHeight(new BiomeGenBase.Height(this.rootHeight + 0.1F, this.heightVariation + 0.1F));
        var1.rootHeight = this.rootHeight + 0.3F;
        var1.heightVariation = this.heightVariation + 0.4F;
        return var1;
    }
}
