...
public class ShaderMacros
{
    ...
    public static String[] extensionMacros;

    public static String getOs()
    {
        Util.EnumOS os = Util.getOSType();

        switch (ShaderMacros.NamelessClass1242528115.$SwitchMap$net$minecraft$util$Util$EnumOS[os.ordinal()])
        {
            case 1:
    ...
    public static class NamelessClass1242528115
    {
        public static final int[] $SwitchMap$net$minecraft$util$Util$EnumOS = new int[Util.EnumOS.values().length];
