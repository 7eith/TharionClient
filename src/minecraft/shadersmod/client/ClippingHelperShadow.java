...
public class ClippingHelperShadow extends ClippingHelper
{
    ...
    public float[] matInvMP = new float[16];
    public float[] vecIntersection = new float[4];
    ...
    public double dot4(float[] plane, double x, double y, double z)
    {
        return (double)plane[0] * x + (double)plane[1] * y + (double)plane[2] * z + (double)plane[3];
    }

    public double dot3(float[] vecA, float[] vecB)
    {
    ...
    public void normalizePlane(float[] plane)
    {
    ...
    public void normalize3(float[] plane)
    {
        float length = MathHelper.sqrt_float(plane[0] * plane[0] + plane[1] * plane[1] + plane[2] * plane[2]);
    ...
    public void assignPlane(float[] plane, float a, float b, float c, float d)
    {
    ...
    public void copyPlane(float[] dst, float[] src)
    {
        dst[0] = src[0];
        dst[1] = src[1];
        dst[2] = src[2];
    ...
    public void cross3(float[] out, float[] a, float[] b)
    {
    ...
    public void addShadowClipPlane(float[] plane)
    {
    ...
    public void makeShadowPlane(float[] shadowPlane, float[] positivePlane, float[] negativePlane, float[] vecSun)
    {
